...
function displayTournaments() {
    ...
    var masters1000Coordinates = [48.8398, 2.2519]; // Exemple de coordonnées (Paris, France)
    ...
    var grandSlamCoordinates = [48.8566, 2.3509]; // Exemple de coordonnées (Paris, France)
